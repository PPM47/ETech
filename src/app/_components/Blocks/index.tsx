...
import { RecommendedProducts, type RecommendedProductsProps } from '../../_blocks/RecommendedProducts'
...
export const Blocks: React.FC<{
  blocks: (Page['layout'][0] | RelatedProductsProps | RecommendedProductsProps)[]
